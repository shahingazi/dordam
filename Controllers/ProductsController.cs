...
namespace PriceComparisonWeb.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Brand,ProductName,ManufacturerPartNumberMPN,EAN,Description,Image_URL,SubCategoryId")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Brand,ProductName,ManufacturerPartNumberMPN,EAN,Description,Image_URL,SubCategoryId")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
