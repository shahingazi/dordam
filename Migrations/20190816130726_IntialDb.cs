...
namespace PriceComparisonWeb.Migrations
{
    public partial class IntialDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "SuperCategoryMappingCategories",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuperCategoryMappingCategories", x => new { x.SuperCategoryId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_SuperCategoryMappingCategories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SuperCategoryMappingCategories_SuperCategories_SuperCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ManufacturerPartNumberMPN = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuperCategoryMappingCategories_CategoryId",
                table: "SuperCategoryMappingCategories",
                column: "CategoryId");
        }
